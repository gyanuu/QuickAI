...
const Footer = () => {
  return (
    ...
    <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500/30 pb-6">
        <div className="md:max-w-96">
            ...
            <p className="mt-6 text-sm">
                ...
                Our platform combines advanced AI tools with a user-friendly interface, empowering creators to produce high-quality. 
                content effortlessly. Join us in revolutionizing the way you create and manage your digital content.
            </p>
        </div>
    ...
    <p className="pt-4 text-center text-xs md:text-sm pb-5">
        Copyright 2026 © QuickAI All Right Reserved.
    </p>
</footer>
  )
}

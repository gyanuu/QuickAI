...
const navItems = [
  ...
  { to: "/ai/review_resume", label: "Review Resume", Icon: FileText },
...
const Sidebar = ({ sidebar, setSidebar }) => {
  ...
  return (
    <div
      className={`w-60 bg-white border-r border-gray-200 flex flex-col justify-between item-center max-sm:absolute top-14 bottom-0 ${

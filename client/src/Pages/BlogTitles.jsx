  ...
  return (
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700 '>
      ...
      <form onSubmit={onSubmitHandler} className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200'>
        ...
        {/* right col */}
        <div className='w-full max-w-lg p-4 bg-white rounded-lg flex flex-col border border-gray-200 min-h-96 min-h-96 '>
          <div className='flex items-center gap-3'>
          ...
          </div>
          {
            ...
            <div className='text-sm flex flex-col items-center gap-5 text-gray-400'>
               <Hash className='w-9 h-9 mx-auto mb-2'/>
               <p>Enter a topic and click "Generate title" to get started</p>
            </div>
          </div>
            ) :(
              <div className='mt-3 h-full overflow-y-scroll text-sm text-state-600'>
